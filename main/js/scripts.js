(function(){
	...
	function switchPagination(){
		...
		let paginationStart = document.querySelector('.pagination .page-item:first-child');
		let paginationEnd = document.querySelector('.pagination .page-item:last-child');
